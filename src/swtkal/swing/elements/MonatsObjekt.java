...
// XXX Farbkodierungen evtl. an eine zentrale Stelle verschieben?	
   ...
   static final Color FEIERTAG_FOREGRD = Color.red;                 // Feiertag
	...
	private JPanel createMtSelect(int mt, int yr)
	{
		...
		//Image Path erneuert. bin/ davor gepackt. 
		//hier ist jetzt eine bin raus gekommen.
		//branches sind toll
		
		JButton b1 = new JButton(new ImageIcon("bin/images/left.gif"));
		b1.setMargin(new Insets(0, 0, 0, 0));
		b1.setAlignmentY((float) 0.5);
		b1.setRolloverEnabled(true);
		b1.setRolloverIcon(new ImageIcon("bin/images/leftRollover.gif"));
		b1.setActionCommand("previousMonth");
		b1.addActionListener(this);

		JButton b2 = new JButton(new ImageIcon("bin/images/right.gif"));
		b2.setMargin(new Insets(0, 0, 0, 0));
		b2.setAlignmentY((float) 0.5);
		b2.setRolloverEnabled(true);
		b2.setRolloverIcon(new ImageIcon("bin/images/rightRollover.gif"));
